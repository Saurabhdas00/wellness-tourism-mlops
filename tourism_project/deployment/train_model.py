...
for model_name, model in models.items():
    ...
    with mlflow.start_run(
        ...
        # NOTE: use cloudpickle serialization instead of the skops default.
        # Recent mlflow/skops versions refuse to reload tree-based models
        # (DecisionTree/RandomForest/GradientBoosting/XGBoost) unless the
        # sklearn.tree._tree.Tree type is explicitly marked as trusted.
        # Since we trust our own training pipeline, cloudpickle avoids that
        # audit step entirely.
