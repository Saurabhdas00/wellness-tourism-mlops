...
tuned_results = pd.DataFrame([
    {
        ...
        "Test Accuracy": rf_metrics[
            "accuracy"
        ],
        "Test Precision": rf_metrics[
            "precision"
        ],
        "Test Recall": rf_metrics[
            "recall"
        ],
        "Test F1": rf_metrics[
            "f1"
        ],
        "Test ROC-AUC": rf_metrics[
            "roc_auc"
        ],
        "Test PR-AUC": rf_metrics[
            "pr_auc"
        ]
    },
    {
        "Model": "KNN",
        "CV ROC-AUC": knn_search.best_score_,
        "Test Accuracy": knn_metrics[
            "accuracy"
        ],
        "Test Precision": knn_metrics[
            "precision"
        ],
        "Test Recall": knn_metrics[
            "recall"
        ],
        "Test F1": knn_metrics[
            "f1"
        ],
        "Test ROC-AUC": knn_metrics[
            "roc_auc"
        ],
        "Test PR-AUC": knn_metrics[
            "pr_auc"
        ]
    }
])
...
# Select final model
if rf_metrics["roc_auc"] >= knn_metrics["roc_auc"]:

    final_model = rf_best
    final_model_name = "Random Forest"
    final_metrics = rf_metrics
    final_cv_score = rf_search.best_score_
    final_params = rf_search.best_params_
    ...
    final_cv_score = knn_search.best_score_
    final_params = knn_search.best_params_
...
model_info = {
    ...
    "random_state": RANDOM_STATE,
    "input_features": prepared_data[
        "input_features"
    ],
    "processed_features": prepared_data[
        "processed_features"
    ],
    "training_samples": prepared_data[
        "training_samples"
    ],
    "testing_samples": prepared_data[
        "testing_samples"
    ]
}
